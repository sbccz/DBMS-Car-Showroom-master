	...
	<div class="wrap">
        ...
        <form class="text-center" action="booking.php" method="post" >
           ...
           <div>
             ...
             <div><br>
                <button id="booking" onclick="booking_function()" type="submit" name="book" class="btn btn-warning" value="book">Book the car</button>
                <div>
...
<!-- <script>
	function booking_function(){
		const cont = document.getElementById('booking');
	}
</script> -->
