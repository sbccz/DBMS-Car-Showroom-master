	...
	<div class="wrap">
        ...
        <form class="text-center" action="booking.php" method="post" >
           ...
           <div>
             ...
             <div><br>
                <button id="booking" type="submit" name="book" class="btn btn-warning" value="book">Book the car</button>
				<!-- <div id="popup" class="">
                    <H3>Payment Option</H3>
                    <button class="btn btn-warning">Online Payment</button>
...
<div class="footer">
	...
	<!-- <script>
		const popupPayment = document.getElementById('popup');
		popupPayment.style.display = 'none';

		document.getElementById('booking').addEventListener('click', function(){
    		const noticeArea = document.getElementById('popup');
